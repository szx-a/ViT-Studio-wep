...
用法:
    python inference.py <图片路径> [--top-k 5] [--output result.json]

示例:
    python inference.py cat.jpg
    python inference.py cat.jpg --top-k 3 --output result.json
"""
...
def main():
    ...
    # 2) 推理
    results = predict(img, top_k=args.top_k)
